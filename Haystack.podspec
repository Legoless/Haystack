#
#  Be sure to run `pod spec lint Haystack.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Dal Rupnik" => "legoless@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Dal Rupnik', 'other author'
